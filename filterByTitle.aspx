<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="filterByTitle.aspx.cs" Inherits="filterByAuthor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="body">
        <div class="filterByTitleTitle text-center" style="border-color: #CC0000; background-color: #FFFFCC; border-radius: 1px; padding-top: 1px; padding-bottom: 1px; margin-bottom: 5px; border-top-style: solid; border-bottom-style: solid;">
            <h3><b>Search By Title</b></h3>
            <h5><span class="glyphicon glyphicon-pencil"></span><i style="color: #FF0000">Please enter the title of a book in the input box..</i></h5>

            <div class="container-fluid">
                <div class="form-group">
                    <asp:TextBox ID="titleTxt" runat="server" CssClass="form-control center-block text-center" placeholder="please enter the book name here.." Font-Bold="False"></asp:TextBox>
                </div>
                <div class="form-group">
        ...
        <div class="col-xs-12" style="margin-top: 0%; background-color: #CCFFFF; text-align: center;">
            ...
            <asp:SqlDataSource ID="booksDataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="selectBookByTitle" SelectCommandType="StoredProcedure">
                <SelectParameters>
                    <asp:ControlParameter ControlID="titleTxt" Name="title" PropertyName="Text" Type="String" />
                </SelectParameters>
            </asp:SqlDataSource>
        </div>
